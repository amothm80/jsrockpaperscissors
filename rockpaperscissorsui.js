...
function playRound(humanChoice, computerChoice){
    ...
    let rT = document.querySelector("#result").firstChild;
    rT.textContent = result;
    let hS = document.querySelector("#playerScore").firstChild;
    hS.textContent = `Human score is ${humanScore}`;
    let cS = document.querySelector("#computerScore").firstChild;
